...
@Component({
  selector: 'nasa-cestrela',
  templateUrl: './cestrela.component.html',
  styleUrls: ['./cestrela.component.css']
})
export class CestrelaComponent implements OnInit {
